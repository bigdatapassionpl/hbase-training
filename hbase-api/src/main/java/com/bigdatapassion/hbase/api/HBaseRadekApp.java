...
import com.bigdatapassion.hbase.api.util.HbaseConfigurationFactory;
...
public class HBaseRadekApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection connection = ConnectionFactory.createConnection(HbaseConfigurationFactory.getConfiguration());
